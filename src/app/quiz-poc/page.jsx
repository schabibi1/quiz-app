...
function QuizHome() {
  ...
  // const [score, setScore] = useState(initScoreState);
  ...
  const handleSubmitAnswer = async () => {
	...
	if (selectedAnswer !== null) {// 🚨 Review this condition
	  ...
	  updatedPlayers[currentPlayerIndex].score = score.score;
	  setPlayers(updatedPlayers);
	  setScore(score.score);// Not mutating score
	  console.log('score: ', score);// TODO: Mutate score
	}
  ...
  // 🚨 POST req is not triggered -> Only triggered when testing in Postman
	...
	return (
	  <div>
		...
		{players.map((player, index) => (
		  ...
		  >
			{/* Update player.score (i.e. score.score) */}
